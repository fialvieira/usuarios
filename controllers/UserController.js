class UserController {
    constructor(formIdCreate, formIdUpdate, tableId) {
        ...
        this.tableEl = document.getElementById(tableId).querySelector("tbody");
        this.onSubmit();
        this.onEdit();
        this.selectAll();
    }
    ...
    getTr(dataUser, tr = null) {
        ...
        tr.innerHTML = `
                    ...
                    <td>${Utils.dateTimeFormat(dataUser.register)}</td>
                    <td>
    ...
    getValues(formEl) {
        ...
        [...formEl.elements].forEach((field, index) => {
            ...
            if (field.name === "gender") {
                if (field.checked) {
                    user[field.name] = (field.id == 'exampleInputGenderM') ? 'M' : 'F';
                }
    ...
    onEdit() {
        ...
        this.formUpdateEl.addEventListener("submit", event => {
            ...
            let btn = this.formUpdateEl.querySelector("button[type=submit]");
            btn.disabled = true;
    ...
    onSubmit() {
        this.formEl.addEventListener("submit", (event) => {
            event.preventDefault();
            let btn = this.formEl.querySelector("button[type=submit]");
            btn.disabled = true;
